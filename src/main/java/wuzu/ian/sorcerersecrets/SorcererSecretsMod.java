...
@Mod("sorcerer_secrets")
public class SorcererSecretsMod {
	public static final Logger LOGGER = LogManager.getLogger(SorcererSecretsMod.class);
	public static final String MODID = "sorcerer_secrets";

	public SorcererSecretsMod() {
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									SorcererSecretsMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			SorcererSecretsMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
